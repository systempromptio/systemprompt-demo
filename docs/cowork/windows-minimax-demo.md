...
Latest Windows build is in **[the latest release](https://github.com/systempromptio/systemprompt-demo/releases/latest)** — asset `systemprompt-bridge-x86_64-pc-windows-msvc.exe`.
