...
```bash
curl -sSL -O https://github.com/systempromptio/systemprompt-demo/releases/latest/download/SHA256SUMS.bridge
...
```bash
cosign verify-blob \
  --certificate-identity-regexp='https://github.com/systempromptio/systemprompt-demo/' \
