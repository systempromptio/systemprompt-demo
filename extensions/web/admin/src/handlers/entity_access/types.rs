...
// Why: JSON body returned by [`super::list_entity_access_handler`].
...
// Why: JSON body returned by [`super::upsert_entity_rule_handler`].
#[derive(Debug, Serialize)]
...
// Why: JSON body returned by [`super::set_entity_default_handler`].
#[derive(Debug, Serialize)]
...
// Why: One entry in [`ListAllEntityAccessResponse::entities`].
#[derive(Debug, Serialize)]
...
// Why: JSON body returned by [`super::list_all_entity_access_handler`].
#[derive(Debug, Serialize)]
...
// Why: JSON body returned by [`super::apply_template_handler`].
#[derive(Debug, Serialize)]
