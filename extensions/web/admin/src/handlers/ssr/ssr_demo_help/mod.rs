...
pub(super) fn demo_help_text(page: &str) -> (&'static str, &'static str) {
    demo_help_core_pages(page)
        ...
        .unwrap_or((
            "This page is part of the <strong>systemprompt.io</strong> gateway. It exercises one slice of the governance, analytics, or workspace pipeline end-to-end so you can see how the platform behaves in production. Data shown here is real telemetry from the running stack &mdash; install the <strong>Systemprompt Bridge</strong> and connect via <strong>Claude Cowork</strong> to populate it with your own sessions.",
            "dashboard",
        ))
}
