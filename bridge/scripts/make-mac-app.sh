#!/usr/bin/env bash
# Wrap the systemprompt-bridge binary in a macOS .app bundle.
#
...
# bridge/target/<triple>/release/SystempromptBridge.app (or target/release/... when
...
if [[ -n "$TARGET" ]]; then
    BIN="target/$TARGET/release/systemprompt-bridge"
    OUT_DIR="target/$TARGET/release"
else
    BIN="target/release/systemprompt-bridge"
