...
prepare:
    ...
    EXTENSION_DIRS="extensions/cli/activity extensions/cli/slack extensions/credits extensions/web extensions/marketplace extensions/mcp/shared extensions/mcp/agent"
